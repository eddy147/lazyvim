...
local black = "#101017"
local bright_black = "#43435a"
local red = "#ff568e"
local bright_red = "#ff69a2"
local green = "#64de83"
local bright_green = "#73de8a"
local yellow = "#efff73"
local bright_yellow = "#f3ff85"
local blue = "#73a9ff"
local bright_blue = "#85b6ff"
local magenta = "#946ff7"
local bright_magenta = "#a481f7"
local cyan = "#62c6da"
local bright_cyan = "#71c2d9"
local white = "#dedeff"
local bright_white = "#ebebff"

local bg = black
local fg = white
local comment = bright_black
local keyword = bright_magenta
local function_ = bright_blue
local constant = bright_cyan
local type_ = yellow
local visual = bright_black
local string_ = bright_green
local variable = cyan
...
local highlights = {
  ...
  ["@attribute"] = { fg = red }, -- Elixir attributes like @module_attribute
