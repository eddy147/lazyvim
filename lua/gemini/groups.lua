...
local function setup(configs)
  ...
  return {
    ...
    NormalFloat = { fg = colors.purple, bg = colors.bg },
    ...
    ["@function"] = { fg = colors.yellow },
    ["@function.call.elixir"] = { fg = colors.white },
    ...
    ["@variable.elixir"] = { fg = colors.blue },
    ...
    ["@lsp.type.type"] = { fg = colors.bright_blue },
    ...
    GitSignsChangeLn = { fg = colors.black, bg = colors.blue },
    ...
    CodeActionNumber = { bg = "NONE", fg = colors.blue },
    ...
    CmpItemAbbrMatch = { fg = colors.blue, bg = colors.bg },
    ...
    BlinkCmpLabelMatch = { fg = colors.blue, bg = colors.menu },
    ...
    RainbowDelimiterblue = { fg = colors.fg },
    ...
    MiniStatuslineModeCommand = { fg = colors.black, bg = colors.blue, bold = true },
    ...
    DashboardIcon = { fg = colors.blue, bold = true },
    ...
    DapUIScope = { fg = colors.bright_blue },
    DapUIModifiedValue = { fg = colors.bright_blue, bold = true },
    DapUIDecoration = { fg = colors.bright_blue },
    DapUIThread = { fg = colors.bright_green },
    DapUIStoppedThread = { fg = colors.bright_blue },
    DapUISource = { fg = colors.bright_blue },
    DapUILineNumber = { fg = colors.bright_blue },
    DapUIFloatBorder = { fg = colors.bright_blue },
    DapUIWatchesEmpty = { fg = colors.pink },
    DapUIWatchesValue = { fg = colors.bright_green },
    DapUIWatchesError = { fg = colors.pink },
    DapUIBreakpointsPath = { fg = colors.bright_blue },
    DapUIBreakpointsInfo = { fg = colors.bright_green },
    DapUIBreakpointsCurrentLine = { fg = colors.bright_green, bold = true },
    DapStoppedLine = { default = true, link = "Visual" },
    DapUIWinSelect = { fg = colors.bright_blue, bold = true },
    ...
    SnacksPickerTitle = { fg = colors.blue, bold = true },
